...
@section('title', "Perfis para a Permissão: {$permission->name}")
...
@section('content_header')
        ...
        <div class="card-header">
            <nav aria-label="LaraFood BreadCrumb">
                <ol class="breadcrumb text-dark">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('permission.profiles', $permission->id) }}">Permissões</a>
                    </li>
    ...
    <h1 class="mb-2">Perfis disponíveis para: <b>{{ $permission->name }}</b></h1>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <form action="{{ route('permission.profiles.available', $permission->id) }}" method="POST" class="form">
                @csrf
                <div class="row">
