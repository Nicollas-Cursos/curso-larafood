...
@section('title', "Permissões para o Cargo: {$role->name}")
...
@section('content_header')
        ...
        <div class="card-header">
            <nav aria-label="LaraFood BreadCrumb">
                <ol class="breadcrumb text-dark">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('role.permissions', $role->id) }}">Permissões</a>
                    </li>
    ...
    <h1 class="mb-2">Permissões disponíveis para: <b>{{ $role->name }}</b></h1>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <form action="{{ route('role.permissions.available', $role->id) }}" method="POST" class="form">
                @csrf
                <div class="row">
